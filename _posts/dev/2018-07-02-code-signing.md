...
* [A *certificate*](https://en.wikipedia.org/wiki/Public_key_certificate) contains public information about me and a private key. Anyone can see my certificate, but only I can produce a signature with it because I keep the key secret. Anyone can create a certificate for free on their own, but Windows apps won't treat this as "trusted" unless you get a certificate from a CA.
